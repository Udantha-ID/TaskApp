...
import com.example.taskapp.ScreenTwo
import com.example.taskapp.StopWatch
...
class HomeFragment : Fragment(R.layout.fragment_home),SearchView.OnQueryTextListener,MenuProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Navigate to StopWatch Activity when the Stopwatch button is clicked
        binding.StopWatch.setOnClickListener {
            val intent = Intent(requireContext(), StopWatch::class.java)
...
//    val openStopWatch = findViweById(R.id.StopWatch)
}